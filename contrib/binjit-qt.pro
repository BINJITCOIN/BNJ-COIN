...
RESOURCES += src/qt/binjit.qrc src/qt/binjit_locale.qrc

TRANSLATIONS += src/qt/locale/binjit_bg.ts \
                src/qt/locale/binjit_de.ts \
                src/qt/locale/binjit_en.ts \
                src/qt/locale/binjit_es.ts \
                src/qt/locale/binjit_fi.ts \
                src/qt/locale/binjit_fr.ts \
                src/qt/locale/binjit_it.ts \
                src/qt/locale/binjit_ja.ts \
                src/qt/locale/binjit_pl.ts \
                src/qt/locale/binjit_pt.ts \
                src/qt/locale/binjit_ru.ts \
                src/qt/locale/binjit_sk.ts \
                src/qt/locale/binjit_sv.ts \
                src/qt/locale/binjit_vi.ts \
                src/qt/locale/binjit_zh_CN.ts \
                src/qt/locale/binjit_zh_TW.ts
