...
The script [extract-osx-sdk.sh](https://github.com/binjit-project/binjit/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
binjit/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/binjit-project/binjit/blob/master/doc/README_osx.md) for troubleshooting tips.
