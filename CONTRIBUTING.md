Contributing to BinJit
============================

The BinJit project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/binjit-project/binjit/blob/master/doc/translation_process.md)
...
The following applies to code changes to the BinJit project, and is not to be
confused with overall BinJit Network Protocol consensus changes.

Whether a pull request is merged into BinJit rests with the project merge
...
Patches that change BinJit consensus rules are considerably more involved than
...
Where a patchset proposes to change the BinJit consensus, it must have been
...
The project leader is the release manager for each BinJit release.
