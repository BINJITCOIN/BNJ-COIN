...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw std::runtime_error(
            "stop\n"
            "\nStop BinJit Coin server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "BinJit Coin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* BinJit features */
        {"binjit", "listmasternodes", &listmasternodes, true, true, false},
        {"binjit", "getmasternodecount", &getmasternodecount, true, true, false},
        {"binjit", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"binjit", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"binjit", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"binjit", "masternodecurrent", &masternodecurrent, true, true, false},
        {"binjit", "masternodedebug", &masternodedebug, true, true, false},
        {"binjit", "startmasternode", &startmasternode, true, true, false},
        {"binjit", "createmasternodekey", &createmasternodekey, true, true, false},
        {"binjit", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"binjit", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"binjit", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"binjit", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"binjit", "getmasternodescores", &getmasternodescores, true, true, false},
        {"binjit", "preparebudget", &preparebudget, true, true, false},
        {"binjit", "submitbudget", &submitbudget, true, true, false},
        {"binjit", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"binjit", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"binjit", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"binjit", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"binjit", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"binjit", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"binjit", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"binjit", "checkbudgets", &checkbudgets, true, true, false},
        {"binjit", "mnsync", &mnsync, true, true, false},
        {"binjit", "spork", &spork, true, true, false},
...
{
    return "> binjit-cli " + methodname + " " + args + "\n";
}
