...
/** Utility functions used by the BinJit Qt UI.
 */
namespace GUIUtil
{
...
// Render BinJit addresses in monospace font
...
// Parse "binjit:" URI into recipient object, return true on successful parsing
