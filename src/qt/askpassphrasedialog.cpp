...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            BinJitGUI* window = static_cast<BinJitGUI*>(parentWidget());
...
{
    BinJitGUI* gui = static_cast<BinJitGUI*>(parentWidget());
...
{
    hide();
    static_cast<BinJitGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("BinJit Coin will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your BNJs from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
