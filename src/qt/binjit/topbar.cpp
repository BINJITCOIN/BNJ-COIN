...
#include "qt/binjit/topbar.h"
#include "qt/binjit/forms/ui_topbar.h"
#include "qt/binjit/lockunlock.h"
#include "qt/binjit/qtutils.h"
#include "qt/binjit/receivedialog.h"
#include "qt/binjit/loadingdialog.h"
...
TopBar::TopBar(BinJitGUI* _mainWindow, QWidget *parent) :
    ...
    ui(new Ui::TopBar)
{
    ...
    setCssProperty({ui->labelAmountTopBNJ}, "amount-small-topbar");
    setCssProperty({ui->labelAmountBNJ}, "amount-topbar");
    setCssProperty({ui->labelPendingBNJ, ui->labelImmatureBNJ}, "amount-small-topbar");
...
void TopBar::loadWalletModel()
{
    ...
    // update the display unit, to not use the default ("BinJit")
    updateDisplayUnit();
                            ...
                            const CAmount& delegatedBalance, const CAmount& coldStakedBalance)
{
    ...
    // BNJ Total
    QString totalBNJ = GUIUtil::formatBalance(balance, nDisplayUnit);

    // BNJ
    // Top
    ui->labelAmountTopBNJ->setText(totalBNJ);
    // Expanded
    ui->labelAmountBNJ->setText(totalBNJ);
    ui->labelPendingBNJ->setText(GUIUtil::formatBalance(unconfirmedBalance, nDisplayUnit));
    ui->labelImmatureBNJ->setText(GUIUtil::formatBalance(immatureBalance, nDisplayUnit));
}
