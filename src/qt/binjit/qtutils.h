...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, BinJitGUI* gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog* widget, BinJitGUI* gui, double posX = 3);
