...
#include "qt/binjit/sendcustomfeedialog.h"
#include "qt/binjit/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(BinJitGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &BinJitGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
