...
#ifndef BinJit_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define BinJit_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //BinJit_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
