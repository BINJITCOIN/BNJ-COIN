...
#include "qt/binjit/forms/ui_masternodeswidget.h"

#include "qt/binjit/qtutils.h"
#include "qt/binjit/mnrow.h"
#include "qt/binjit/mninfodialog.h"
#include "qt/binjit/masternodewizarddialog.h"
...
MasterNodesWidget::MasterNodesWidget(BinJitGUI *parent) :
    PWidget(parent),
...
void MasterNodesWidget::onCreateMNClicked()
{
    ...
    if (walletModel->getBalance() <= GetMNCollateral(chainActive.Height()) * COIN) {
        inform(tr("Not enough balance to create a masternode, %1 BNJ required.").arg(GetMNCollateral(chainActive.Height())));
        return;
    }
    showHideOp(true);
