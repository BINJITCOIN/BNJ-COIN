...
#include "qt/binjit/settings/forms/ui_settingsmultisendwidget.h"
#include "qt/binjit/settings/settingsmultisenddialog.h"
    ...
    ui(new Ui::SettingsMultisendWidget)
{
    ...
    ui->labelSubtitle1->setText(tr("MultiSend allows you to automatically send up to 100% of your stake or masternode reward to a list of other BinJit Coin addresses after it matures."));
