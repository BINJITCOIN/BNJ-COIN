...
#include "qt/binjit/settings/settingsnetworkwidget.h"
#include "qt/binjit/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/binjit/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(BinJitGUI* _window, QWidget *parent) :
