...
#include "qt/binjit/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(BinJitGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("BinJit_tx_csv_export(*.csv)") : tr("BinJit_addresses_csv_export(*.csv)"),
                                        nullptr);
