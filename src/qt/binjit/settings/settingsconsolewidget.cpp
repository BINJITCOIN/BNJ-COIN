...
#include "qt/binjit/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/binjit/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(BinJitGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(bool clearHistory)
{
	...
	message(CMD_REPLY, (tr("Welcome to the BinJit Coin RPC console.") + "<br>" +
