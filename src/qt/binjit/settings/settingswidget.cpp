...
#include "qt/binjit/settings/forms/ui_settingswidget.h"
...
SettingsWidget::SettingsWidget(BinJitGUI* parent) :
    PWidget(parent),
    ui(new Ui::SettingsWidget)
{
    ...
    connect(ui->pushButtonHelp1, &QPushButton::clicked, window, &BinJitGUI::openFAQ);
