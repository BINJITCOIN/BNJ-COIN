...
#include "qt/binjit/settings/forms/ui_settingsfaqwidget.h"
#include <QScrollBar>
#include <QMetaObject>
#include "qt/binjit/qtutils.h"

SettingsFaqWidget::SettingsFaqWidget(BinJitGUI *parent) :
    QDialog(parent),
    ui(new Ui::SettingsFaqWidget)
{
    ...
    setCssProperty({
              ...
              ui->labelSubtitle_UnspendableBNJ,
    ...
    setCssProperty({
              ...
              ui->labelContent_UnspendableBNJ,
    ...
    connect(ui->pushButton_UnspendableBNJ, &QPushButton::clicked, [this](){onFaqClicked(ui->widget_UnspendableBNJ);});
    ...
    if (parent)
        connect(parent, &BinJitGUI::windowResizeEvent, this, &SettingsFaqWidget::windowResizeEvent);
}
