...
#include "qt/binjit/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/binjit/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(BinJitGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to BinJitGUI::handleRestart()
