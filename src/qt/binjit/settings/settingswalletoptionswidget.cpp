...
#include "qt/binjit/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/binjit/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(BinJitGUI* _window, QWidget *parent) :
