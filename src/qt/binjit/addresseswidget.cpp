...
#include "qt/binjit/forms/ui_addresseswidget.h"
#include "qt/binjit/addresslabelrow.h"
#include "qt/binjit/addnewaddressdialog.h"
#include "qt/binjit/tooltipmenu.h"
...
AddressesWidget::AddressesWidget(BinJitGUI* parent) :
    PWidget(parent),
...
void AddressesWidget::onStoreContactClicked()
{
    if (walletModel) {
        ...
        CTxDestination bnjAdd = DecodeDestination(address.toUtf8().constData(), isStakingAddress);
        ...
        if (walletModel->updateAddressBookLabels(bnjAdd, label.toUtf8().constData(),
