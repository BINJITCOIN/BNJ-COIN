...
/* BinJit GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "BinJit Coin"
#define QAPP_ORG_DOMAIN "binjit.trade"
#define QAPP_APP_NAME_DEFAULT "BinJit Coin-Qt"
#define QAPP_APP_NAME_TESTNET "BinJit Coin-Qt-testnet"
