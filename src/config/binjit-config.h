/* src/config/binjit-config.h.  Generated from binjit-config.h.in by configure.  */
/* src/config/binjit-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef BINJITCONFIG_H

#define BINJITCONFIG_H
...
#define PACKAGE_BUGREPORT "https://github.com/binjit-project/binjit/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "BNJ Coin"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "BNJ Coin 1.1.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "binjit"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://binjit.trade/"
