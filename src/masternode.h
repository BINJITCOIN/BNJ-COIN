...
//
// The Masternode Class. It contains the input of the 1000 BNJ, signature to prove
...
public:
    ...
    /// Is the input associated with collateral public key? (and there is 1000 BNJ - checking if valid masternode)
